...
app.post('/overalltermmarkinsert-service',  urlencodedParser,function (req, res){
  ...
  var updatequr="Update tr_term_assesment_overall_marks SET total=(SELECT sum(mark) as total from tr_term_assesment_marks where academic_year='"+req.query.academicyear+"' "+
  "and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' and assesment_id='"+req.query.assesmentid+"' "+
  "and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"'), "+
  " rtotal=(SELECT sum(mark)/count(*) as rtotal from tr_term_assesment_marks where academic_year='"+req.query.academicyear+"' "+
  "and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' and assesment_id='"+req.query.assesmentid+"' "+
  "and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"') "+
...
"and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' "+
"and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"'";
var updatequr="UPDATE tr_term_assesment_overall_assesmentmarks SET total=(SELECT sum(rtotal) as total from tr_term_assesment_overall_marks where "+
"academic_year='"+req.query.academicyear+"' "+
"and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' "+
"and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"') "+
" ,rtotal=(SELECT sum(rtotal)/count(*) as average from tr_term_assesment_overall_marks where "+
"academic_year='"+req.query.academicyear+"' "+
"and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' "+
"and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"') "+
" ,term_cat_grade=(SELECT (SELECT grade from md_grade_rating where lower_limit<=round((sum(rtotal)/count(*)),1) && higher_limit>=round((sum(rtotal)/count(*)),1)) as term_cat_grade from tr_term_assesment_overall_marks where "+
"academic_year='"+req.query.academicyear+"' "+
"and school_id='"+req.query.schoolid+"' and term_name='"+req.query.termname+"' "+
"and grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' and student_id='"+req.query.studentid+"') "+
" WHERE academic_year='"+req.query.academicyear+"' "+
...
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"'  and flag='active' order by student_name";
  ...
  var qur4=" SELECT count(sub_category)as counvalue,sub_category,category_name FROM md_coscholastic_metrics WHERE category_name='"+req.query.subjects+"'group by sub_category order by sub_category";
...
{ 
    ...
    " tr_beginner_assesment_marks where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' "+
    " and grade_id='"+req.query.gradename+"' and section_id='"+req.query.sectionname+"' and assesment_type='"+req.query.assesment+"' "+
    ...
    var qur2="select count(distinct(student_id)) as count,subject_name,level,grade from tr_beginner_assesment_marks where "+
    ...
    " assesment_type='"+req.query.assesment+"' group by subject_name,level,grade";
    console.log("------------------Fetch students----------------------");
    console.log(qur);
    var arr=[];
    connection.query(qur,  function(err, rows)
...
{ 
    var qur="select distinct(student_name),"+req.query.configcolumn+" as category,level,grade,assesment_id from tr_beginner_assesment_marks "+
    ...
    " and subject_name='"+req.query.subject+"' and sub_category_name='"+req.query.subcategory+"' and level='"+req.query.level+"' group by student_name, "+
    " subject_name,sub_category_name,"+req.query.configcolumn+",assesment_id,grade,level order by assesment_id,"+req.query.configcolumn+"";  
    var qur1="select distinct(student_name),"+req.query.configcolumn+" as category,level,grade,assesment_id from tr_beginner_assesment_marks "+
    " where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and grade_id='"+req.query.gradename+"' and section_id='"+req.query.sectionname+"' "+
    " and subject_name='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and sub_category_name='"+req.query.subcategory+"' and level='"+req.query.level+"' group by student_name, "+
    " subject_name,assesment_id,sub_category_name,"+req.query.configcolumn+",assesment_id,grade,level order by "+req.query.configcolumn+"";    
    console.log("------------------Fetch students----------------------");
    console.log(qur);
    var arr=[];
    connection.query(qur,  function(err, rows)
